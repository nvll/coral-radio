...
uint32_t create_coral_ipc_rx_char(void)
{
    ...
    // Set up the characteristic values (buffer for storing data mostly)
    ...
    // Set up permissions and user level description of the charactistics
...
uint32_t ble_create_gatt_services(void)
{
    ...
    /* Nordic Device Information Service. Values largely exist for testing at the moment. */
